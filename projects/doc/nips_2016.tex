...
\subsection{10}
Table \ref{pooling_comparison} shows different pooling kernel sizes.
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/pool_cpu}
	\caption{The network}
	\label{fig:pooling_cpu}
\end{figure}
\begin{table}[t]
	\caption{pooling kernel size comparison}
	\label{pooling_comparison}
	\centering
	\begin{tabular}{lll}
		\toprule
