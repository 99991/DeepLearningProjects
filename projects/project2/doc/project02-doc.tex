...
%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{enumerate}
		...
		\end{item}
			...
			%which can remember values for either long or shirt durations of time. It achieves this by omitting the activation function wich would otherwise reduce the value over time,
